...
class FaunaActivity : AppCompatActivity() {
    ...
    private fun loadObservationData() {
        CoroutineScope(Dispatchers.Main).launch {
            Toast.makeText(this@FaunaActivity, "Loading Fauna...", Toast.LENGTH_SHORT).show()
            ...
            if (itemList.isNotEmpty()) {
                ...
                Toast.makeText(this@FaunaActivity, "No fauna sightings found.", Toast.LENGTH_LONG).show()
            }
        }
    }
