...
class PhenomenaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.phenomenaRecyclerView)
    ...
    private fun setupRecyclerView() {
        ...
        recyclerView.apply {
            layoutManager = GridLayoutManager(this@PhenomenaActivity, 1)
    ...
    private fun loadObservationData() {
        CoroutineScope(Dispatchers.Main).launch {
            Toast.makeText(this@PhenomenaActivity, "Loading Phenomena...", Toast.LENGTH_SHORT).show()
            ...
            if (itemList.isNotEmpty()) {
                ...
                Toast.makeText(this@PhenomenaActivity, "No Phenomena sightings found.", Toast.LENGTH_LONG).show()
            }
        }
    }
