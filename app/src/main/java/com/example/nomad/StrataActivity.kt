...
class StrataActivity : AppCompatActivity() {
    ...
    private fun loadObservationData() {
        CoroutineScope(Dispatchers.Main).launch {
            Toast.makeText(this@StrataActivity, "Loading Strata...", Toast.LENGTH_SHORT).show()
            ...
            if (itemList.isNotEmpty()) {
                ...
                Toast.makeText(this@StrataActivity, "No Strata sightings found.", Toast.LENGTH_LONG).show()
            }
        }
    }
