...
class FaunaActivity : AppCompatActivity() {
    ...
    private val CATEGORY_NAME = "Fauna"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.faunaRecyclerView)
    ...
    private fun setupRecyclerView() {
        ...
        recyclerView.apply {
            layoutManager = GridLayoutManager(this@FaunaActivity, 1)
            adapter = observationAdapter
        }
    }

    // ✅ ✅ ✅ OFFLINE + ONLINE SMART LOADING (MATCHED WITH ObservationItem)
    private fun loadObservationData() {
        ...
        if (isInternetAvailable(this)) {
            ...
            lifecycleScope.launch {
                ...
                if (itemList.isNotEmpty()) {
                    ...
                    val offlinePosts = itemList.map { post ->
                        OfflinePostEntity(
                            observationId = post.id,              // ✅ FIXED
                            imageUrl = post.imageUrl,
                            caption = post.description,           // ✅ FIXED (not caption)
                            category = CATEGORY_NAME,
                            username = post.title,                // ✅ TEMP title used as display text
                            timestamp = post.dateObserved ?: ""   // ✅ FIXED
                        )
                    }
                    ...
                    Toast.makeText(this@FaunaActivity,
                        "No fauna sightings found.",
            ...
            // ✅ ✅ ✅ OFFLINE MODE
            Toast.makeText(this,
                "Offline Mode – Showing Saved Fauna",
